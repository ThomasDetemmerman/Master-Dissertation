...
\begin{figure}[h!]
\centering
  \includegraphics[width=\linewidth]{netwerkIllustrationSARSources.png}
...
\caption{
  Bijdrage van elke bron aan de totale SAR waaraan de gemiddelde gebruiker bloodgesteld is. 
