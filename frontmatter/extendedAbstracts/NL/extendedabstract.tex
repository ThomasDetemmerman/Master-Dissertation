...
Verschillende onderzoeken berekenen de electromagnetische veldsterkte van verschillende bronneen \cite{J6_originalExposureFormula,J1,J10_RDP,J10.1} 
waarbij sommigen de \gls{UL} electromagnetische veldsterkte geconverteerd wordt naar locale \gls{SAR} \cite{J10_RDP,J10.1}. 
...
Uiteindelijk beschrijft \cite{J22_plets2015joint} hoe de electromagnetische veldsterkte omgezet kan worden 
...
met de richting van de geplaatste anntenes op de drone. 
Gangula et al. illustreerdt in \cite{U10} hoe drones gebruikt kunnen worden voor \gls{LTE}
en
...
Eén onderzoekgsgebied dat uitgebreid onderzocht wordt is het optimaliseren van de lacaties ware drones zich moeten bevinden.
Deze algorithmen trachten bepaalde doelstellingen zoals minimaal energieverbruik of korste vlieg afstand te bereiken \cite{U6,U7,U8,U9}.
Deze optimalistatie kan gebeuren door verschillende implementaties waaronder exacte algorithmen of machinaal leren \cite{U3,U5}.

Onderzoek waarbij de electromagnetische straling gelimiteerd wordt is echter beperkt.
...
van het volledige netwerk minimaal wordt of de electromagnetische bloodstelling van een individu.
Echter onderzoek waarbij een drone-gestuurd netwerk geoptimaliseerd wordt naar electromagnetische straling is 
