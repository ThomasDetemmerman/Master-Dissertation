...
\supervisor{Wout Joseph, Luc Martens}
...
De $SAR^{myUABS}$ varieert voor deze hogere vlieghoogtes tussen
 $160\ nW/kg$ voor een microstrip \gls{PwrC Opt} netwerk en rond $98\ nW/kg$ voor een microstrip \gls{Exp Opt} en \gls{EIRP} \gls{PwrC Opt} netwerk.
...
een lage \gls{pusch}-waarde gebruikt wordt in vergelijking \ref{eq:powerUE} voor het bepalen van de
