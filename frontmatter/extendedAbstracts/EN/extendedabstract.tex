...
\section{Results}
As explained in the previous section, four configurations will be investigated in three different scenrioas
The flying height and number of users, are evaluated by monitoring the power consumption, electromagnetic exposure and \gls{SAR}-values.
