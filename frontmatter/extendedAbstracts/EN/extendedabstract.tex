...
investigates localized \gls{SAR} for head and torso eara.
...
number of 224 users as is average on an usual day at 5 p.m. in Ghent \gls{J2}.
...
all measured values are strictly limited to the mentioned sources and only cover data traffic 
