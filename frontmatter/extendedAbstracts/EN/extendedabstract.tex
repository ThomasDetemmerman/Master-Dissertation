...
Further, the tool now also provide support to optimize the networks towards electromagnetic exposure or power consumption.
...
over a 10 g tissue ($SAR_{10g}$) is defined at $0.8 W/kg$ \cite{J30}. 
...
the \gls{DL} radiation remains constant at 10 $nW/kg$ during the entire time. The reason that the \gls{DL} radiation
...
\begin{figure}[h]
\subfloat[50 users]{\includegraphics[width=0.49\linewidth]{../images/connectionsMap50Users.png}}
\hfill
\subfloat[600 users]{\includegraphics[width=0.49\linewidth]{../images/connectionsMap600Users.png}}
...
The microstrip patch antenna will generate less electromagnetic radiation by design and
 ...
 would further reduce cost without interfering with the Flemish legislation regarding electromagnetic exposure  with more than one millionth of the maximal allowed whole body \gls{SAR}
  with more than one millionth of the maximal allowed whole body \gls{SAR}. with more than one millionth of the maximal allowed whole body \gls{SAR}.
