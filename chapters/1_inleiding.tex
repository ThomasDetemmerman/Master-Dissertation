...
Electromagnetic exposure can however not be neglected. Research shows how electromagnetic radiation can cause diverse biological side effects \cite{bioeffects} and human exposure to these electromagnetic waves should be limited. The ICNIRP %\gls{ICNIRP} 
