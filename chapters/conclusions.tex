...
base station is much higher than expanding its range \cite{J1}.
...
If the goal is to remain in the air for longer period of time, an exposure optimized network is recomended because the power consumption of 
