...
\begin{algorithm}
	\caption{Weighted average of the median  and the $95th$ percentile electric-field strenght} 
	\label{alg:getglobaluserexposure}
     \hspace*{\algorithmicindent} \textbf{Input} users[], $w_1$, $w_2$\\
     \hspace*{\algorithmicindent} \textbf{Output} globalUserExpsoure
	\begin{algorithmic}[1]
		\State Sort users by pathloss
		...
		\State $ Y_1 \gets users[X1].getExposure$ 
		\State $ Y_2 \gets users[Y2].getExposure$ 
