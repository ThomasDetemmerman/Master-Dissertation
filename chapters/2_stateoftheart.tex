...
One type of directional antennae that excessively has been investigated for \gls{UAV}-usage are microstrip antennae
...
to \gls{UAV}s.
Zeng et al. proposes in \cite{A6} the use of such an antenna in sunflower-shaped array configuration.
