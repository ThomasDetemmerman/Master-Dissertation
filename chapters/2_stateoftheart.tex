...
by the government. These limits are location dependent. The \gls{EU} recommends the guidelines as defined by the \gls{ICNIRP} which limit electromagnetic exposure to 61 V/m.
...
The Specific Absorption Rate (\gls{SAR}) represents the rate at which electromagnetic energy is absorbed by human tissue with the thermal 
...
suggests for an individual mobile device a whole body $SAR_{10g}$ of $0.8 W/kg$ and $2 W/kg$ for localized $SAR_{10g}$ at head and torso area \cite{J30}. 
