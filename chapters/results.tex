...
Changing an exposure optimized network with an power consumption optimized network will 
...
a \gls{EIRP} \gls{Exp Opt} network $107\ W$ and a \gls{EIRP} \gls{PwrC Opt} network $92\ W$.
