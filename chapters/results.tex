...
Figure \ref{fig:s2a_dlAndPc}.a further also shows how the electromagnetic radiation from the \gls{UABS}
...
The \gls{DL} exposure in fig. \ref{fig:s2a_dlAndPc} increases along with the flying height. One might expect a more constant 
...
\begin{figure}[h!]
  ...
  \caption{These two figures show how various sizes of population influence the downlink electromagnetic radiation of the average user \mbox{(fig. a)} and 
  power consumption of the entire network \mbox{(fig. b)} for one \acs{UABS} available in the network.}
...
\centering
  ...
  \caption{
    These two figures show how the flying height influences the downlink electromagnetic radiation of the average user \mbox{(fig. a)} and 
  power consumption of the entire network \mbox{(fig. b)} for an unlimited number of drones.
  }
...
\hline                                                                                             %0.1 W = 100 mW                                                            %1e-08 W/kg = 10 nW/kg 
