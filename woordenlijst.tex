...
\newglossaryentry{spuriousradiation}{
	...
	description = Any emission from a radio transmitter at frequencies outside its frequency band
}
...
\newglossaryentry{dielectric constant}{
	name = dielectric constant,
	text = dielectric constant,
	description = The dielectric constant is the ratio of permittivity of the substance to permittivity of free spaces
}
